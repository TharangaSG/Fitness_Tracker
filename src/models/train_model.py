...
# Split data into training and testing sets based on participant "A"
...
# Drop column 'participant' from training and testing sets
...
# Plot the value counts of the 'label' column for the entire dataset
df_train["label"].value_counts().plot(
    kind="bar", ax=ax, color="lightblue", label="Total"
)

# Plot the value counts of the 'label' column for the training set
y_train.value_counts().plot(kind="bar", ax=ax, color="dodgerblue", label="Train")

# Plot the value counts of the 'label' column for the testing set
y_test.value_counts().plot(kind="bar", ax=ax, color="royalblue", label="Test")
